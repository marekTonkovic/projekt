            ...
            <div class="row">
                <nav class="navbar navbar-default navbar-static-top">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">Stone</a>
                    </div>
                    <div class="collapse navbar-collapse" id="main-menu">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="http://localhost:63342/templatemo_452_stone/admin/login.php">Admin</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <a href="contact.php">(BE THERE RIGHT NOW)</a>
                </div>
            </div>
        </div>
    </div>
